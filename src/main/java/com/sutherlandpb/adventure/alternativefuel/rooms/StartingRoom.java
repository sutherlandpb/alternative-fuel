...
public class StartingRoom implements RoomInterface {
    ...
    @Override
    public String look() {
        return "It's the same old office where you clock in and out.  There is an out of date calendar on the wall with a picture of a bright red PRX450, the car looks fast.  There is a door to the North";
    }
